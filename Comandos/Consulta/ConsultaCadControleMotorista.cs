...
{
    public class ConsultaCadControleMotorista
    {
        ...
        public CadControleLista ListaCadControleMotorista(int ID_Motorista)
        {
            ...
            SQL = "SELECT tblControle.ID, tblControle.DataHoraSaida, tblControle.DataHoraChegada, tblControle.Descricao, tblCarro.Marca, tblMotorista.Nome " +
                  ...
                  "WHERE tblControle.ID_Motorista = @ID_Motorista " +
                  "ORDER BY tblControle.DataHoraSaida DESC ";
            try
            {
                conexaoBancoDados.LimparParametros();
                conexaoBancoDados.AdicionarParametros("@ID_Motorista", ID_Motorista);
